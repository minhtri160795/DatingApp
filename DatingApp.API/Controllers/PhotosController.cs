...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IDatingRepository repo, IMapper map, IOptions<CloudinarySettings> cloudinaryConfig)
        {
            _repo = repo;
            _map = map;
        ...
        public async Task<IActionResult> GetPhoto(int id)
        {
            ...
            var photo = _map.Map<PhotoForReturnDto>(photoFormRepo);
            return Ok(photo);
        }
        [HttpPost]
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm] PhotoForCreationDto photoForCreationDto)
        {
            ...
            if (!userFormRepo.Photos.Any(p => p.IsMain))
                photo.IsMain = true;
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            var currenMainPhoto = await _repo.GetCurrentMainPhoto(userId);
